...
struct Stats {
  ...
  struct {
    ...
    int64_t hyb_below;
    int64_t both_below;
    int64_t max_size_reenc_clause;
    int64_t nbin_subs;
    int64_t ulc_alignment;
    int64_t pre_ulcs;
    int64_t res_old;
    int64_t res_new;
    int64_t ulc_below;
    int64_t forced_res;
    int64_t pre_ulcs_below;
    int64_t pre_both;
    int64_t pre_both_below;
    int64_t pre_bin;
    int64_t pre_bin_below;
    int64_t pre_hyb;
    int64_t pre_hyb_below;
    int64_t pre_hybf;
    int64_t pre_hybf_below;
  } order;
