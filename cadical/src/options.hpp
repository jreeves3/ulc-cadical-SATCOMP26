...
OPTION( ulcbeforepre,              1,  0,  1,0,0,0, "perform ulc encoding before preprocessing") \
...
OPTION( ulcfreeze,            0,  0,  1,0,0,0, "Freeze new variables in ULC sequential counter reencodings") \
OPTION( ulckeep,              1,  0,  1,0,0,0, "keep binary clauses o1->02,..., only important if elim is enabled") \
OPTION( ulcprox,              0,  0,  1,0,0,0, "Use proximity ordering for independent or unalignable sets") \
